...
*/
#ifndef V1_TAIKT_MY_INTERFACE_HPP_
#define V1_TAIKT_MY_INTERFACE_HPP_
...
const char* myInterface::getInterface() {
    return ("taikt.myInterface:v1_2");
}

CommonAPI::Version myInterface::getInterfaceVersion() {
...
#endif // V1_TAIKT_MY_INTERFACE_HPP_
