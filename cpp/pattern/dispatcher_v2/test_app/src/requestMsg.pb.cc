...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_requestMsg_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::data::requestMsg, code_),
  PROTOBUF_FIELD_OFFSET(::data::requestMsg, data_),
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_requestMsg_2eproto = {
  &descriptor_table_requestMsg_2eproto_initialized, descriptor_table_protodef_requestMsg_2eproto, "requestMsg.proto", 74,
...
const int requestMsg::kCodeFieldNumber;
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(mutable_data(), ptr, ctx, "data.requestMsg.data");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
void requestMsg::SerializeWithCachedSizes(
  ...
  // uint32 code = 1;
  if (this->code() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32(1, this->code(), output);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* requestMsg::InternalSerializeWithCachedSizesToArray(
  ...
  // uint32 code = 1;
  if (this->code() != 0) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(1, this->code(), target);
  }
