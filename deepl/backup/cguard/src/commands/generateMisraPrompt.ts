...
export function registerGenerateMisraPromptCommand(context: vscode.ExtensionContext) {
  const disposable = vscode.commands.registerCommand('lgedv.generateMisraPrompt', async () => {
