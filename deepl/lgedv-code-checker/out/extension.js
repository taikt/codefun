...
function activate(context) {
    ...
    let checkAI = vscode.commands.registerCommand('lgedv.checkAIViolations', () => {
        ...
        (0, child_process_1.exec)(checkSystemdCommand, { shell: '/bin/bash', encoding: 'utf-8' }, (systemdError, systemdStdout, systemdStderr) => {
            ...
            if (isSystemd) {
                ...
                (0, child_process_1.exec)(checkOllamaServiceCommand, { shell: '/bin/bash', encoding: 'utf-8' }, (checkError, checkStdout, checkStderr) => {
                    if (checkError || !checkStdout.includes('active (running)')) {
                        ...
                        (0, child_process_1.exec)(startOllamaCommand, { shell: '/bin/bash', encoding: 'utf-8' }, (startError, startStdout, startStderr) => {
                            if (startError) {
        ...
        function proceedWithOllama() {
            ...
            (0, child_process_1.exec)(checkOllamaCommand, { shell: '/bin/bash', encoding: 'utf-8' }, (checkOllamaError, checkOllamaStdout, checkOllamaStderr) => {
                ...
                const child = (0, child_process_1.spawn)('bash', ['-c', ollamaCommand], { stdio: ['inherit', 'pipe', 'pipe'], timeout: 600000 });
