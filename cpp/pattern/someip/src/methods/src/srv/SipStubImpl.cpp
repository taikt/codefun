...
myInterfaceStubImpl::myInterfaceStubImpl(std::shared_ptr<Dispatcher>& m_Executor_):
m_Executor(m_Executor_)
{
    cnt = 0;
}

myInterfaceStubImpl::~myInterfaceStubImpl() {
}

void myInterfaceStubImpl::incCounter() {
    cnt++;
...
void myInterfaceStubImpl::foo(const std::shared_ptr<CommonAPI::ClientId> _client,
    ...
    myInterface::stdErrorTypeEnum methodError = myInterface::stdErrorTypeEnum::NO_FAULT;    
    int32_t y1 = 42;
    std::string y2 = "xyz";
